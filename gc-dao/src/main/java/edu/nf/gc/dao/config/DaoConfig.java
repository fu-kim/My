...
public class DaoConfig {
    ...
    public DataSource dataSource(){
        ...
        ds.setUrl("jdbc:mysql://localhost:3306/gc_manager?useSSL=true&useUnicode=true&characterEncoding=utf-8");
        ds.setUsername("test");
        ds.setPassword("test");
        ds.setMaxActive(200);
        ds.setInitialSize(5);
    ...
    public SqlSessionFactoryBean sqlSessionFactory() throws IOException {
        ...
        //设置实体包的别名
        factoryBean.setTypeAliasesPackage("edu.nf.gc.entity");
        //指定mapper映射文件的路径
